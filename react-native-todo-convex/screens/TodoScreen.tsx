...
const styles = StyleSheet.create({
    ...
    header: { paddingTop: 70, paddingHorizontal: 30, paddingBottom: 30 },
    title: { fontSize: 32, fontWeight: "bold", color: "#FFFFFF", marginBottom: 20 },
    searchContainer: {
        flexDirection: 'row', alignItems: 'center',
        backgroundColor: '#FFF', borderRadius: 15, paddingHorizontal: 15
    },
    ...
    input: {
        flex: 1, height: 55, backgroundColor: "#F5F5F5",
        borderRadius: 15, paddingHorizontal: 20
    },
    addButton: {
        backgroundColor: "#FFCC00", borderRadius: 15,
